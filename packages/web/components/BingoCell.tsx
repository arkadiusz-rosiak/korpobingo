...
const BingoCell = forwardRef<HTMLButtonElement, BingoCellProps>(function BingoCell(
  { text, marked, highlight, onToggle, readOnly = false, tabIndex, onKeyDown, onFocus },
  ref,
) {
